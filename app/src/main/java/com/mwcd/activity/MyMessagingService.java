...
public class MyMessagingService extends Service {
    public static final String READ_ACTION =
            "com.mwcd.activity.ACTION_MESSAGE_READ";
    public static final String REPLY_ACTION =
            "com.mwcd.activity.ACTION_MESSAGE_REPLY";
    ...
    private void sendNotification(int conversationId, String message,
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext(),participant)
